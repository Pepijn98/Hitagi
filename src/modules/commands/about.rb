      ...
      command(:about,
              ...
              usage: "#{BOT.prefix}about") do |event|
                ...
                event.channel.send_embed do |embed|
                  ...
                  embed.author = Discordrb::Webhooks::EmbedAuthor.new(name: "Hitagi", url: "http://kurozero.xyz/")
                  ...
                  embed.add_field name: "Website:", value: "http://kurozero.xyz/hitagi", inline:true
